...
console.log(dragShows + " performances each week"); //print to console
...
console.log(falseLashes + " pairs of false eyelashes each week"); //print to console
...
console.log(pantyHose + " pairs of pantyhose each week."); //print to console
...
console.log("Based on your inputs, you'll need " + weeklyLashes + " pairs of false eyelashes and " + weeklyHose + " pairs of pantyhose a week, Hunty! Now put on those stilettos and WERK!");